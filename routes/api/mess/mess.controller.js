...
*/
    ...
    .then(
        ...
        exports.resetpassword = (req, res) => {
          ...
          Mess.findOne({emailAddress: req.body.emailAddress}, function(err, user){
          if(err) {
    ...
    exports.setpassword = (req, res) => {
        ...
        Mess.findById(req.body.userid, function(err, user){
          if(err) {
            res.json({ 'success': false, 'message': err });
          }
          if(!user){
            ...
            .digest('base64')
                ...
                Mess.update(query, userobject, function(err){
                  if(err){
                    res.json({ 'success': false, 'message': err });
                    return;
                  } else {
...
// };
    ...
    exports.verify = (req, res) => {
      ...
      Mess.findByIdAndUpdate(req.body.userid, {$set:{verified: true}}).then(data =>
        {
